...
<head>
    <meta charset="UTF-8"/>
    <title>Reporte de Pedidos - Enviart</title>
    <style>
        body {
        ...
        .badge-RECEPCIONADO { background-color: #6b7280; }
        .badge-EN_TRANSITO { background-color: #2563eb; }
        .badge-ENTREGADO { background-color: #16a34a; }
...
<body>
    <div class="header">
        ...
        <div class="info">Total de pedidos en el sistema: ${total}</div>
    </div>
